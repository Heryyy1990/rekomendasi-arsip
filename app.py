...
def smart_classify(isi_surat, df):
    try:
        ...
        3. ABAIKAN SUMBER DANA: Abaikan kata "DAK", "APBD", "BOS".
        4. HIERARKI DOKUMEN: Jika ada kata "Sertifikat Tanah" atau "Aset Lahan", maka inti surat ADALAH PERTANAHAN, BUKAN BAST.
